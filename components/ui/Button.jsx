  ...
  return (
    <button
      className={clsx(
        ...
        'font-bold tracking-widest uppercase text-[10px] sm:text-[11px]',
        ...
        size === 'sm' && 'px-3 sm:px-4 py-2',
        size === 'md' && 'px-4 sm:px-6 py-2 sm:py-3',
        size === 'lg' && 'px-6 sm:px-8 py-3 sm:py-4 text-[11px] sm:text-[12px]',
